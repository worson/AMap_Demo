...
//        mAMapNavi.stopNavi();
    ...
    public void showLaneInfo(AMapLaneInfo[] laneInfos, byte[] laneBackgroundInfo, byte[] laneRecommendedInfo) {
        ...
        for (AMapLaneInfo info : laneInfos) {
            Log.e(TAG, String.format("typeid :%s ,String: %s ,recommend: %s ", info.getLaneTypeId(), info.getLaneTypeIdHexString(),info.isRecommended()));
        }
    }
